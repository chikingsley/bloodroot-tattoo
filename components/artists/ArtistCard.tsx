...
export function ArtistCard({ artist }: ArtistCardProps) {
  return (
    <Card className="overflow-hidden transition-all hover:shadow-md dark:hover:shadow-primary/5 group bg-card/80 backdrop-blur-sm">
      <CardHeader className="p-0">
        <Link href={`/artist/${artist.slug}`} legacyBehavior passHref>
          <a className="block relative w-full aspect-square overflow-hidden">
            <Image
              src={artist.image}
